...
base = DriveBase(left_port='outB', right_port='outC', wheel_diameter=3.5, wheel_span=14.5)
...
# Moving a motor
gripper = Motor('outA', inverse_polarity=True, gear_ratio=3, setpoint_tolerance=3)
